  ...
  "image-slider": {
    ...
    files: {
      ...
      "script.js": [
        ...
        "//   Create a slides array — each slide is an object with image, title and",
        "//   description — and a let currentIndex = 0 to track the visible slide",
        "",
        "// Step 3: Render the slide",
        "//   Write an updateSlide() that fades the image out, swaps the src, fades",
        "//   back in, and updates the counter, caption and active dot",
        "",
        "// Step 4: Next & previous",
        "//   Next moves the index forward, Previous moves it back — wrap around",
        "//   with if-checks and call updateSlide()",
        "",
        "// Step 5: Auto-advance & event listeners",
        "//   setInterval auto-advances every 4000ms; pause on hover/touch;",
        "//   wire buttons, dots, and keyboard arrows",
        "",
        "// Step 6: Initialize & test",
        "//   Call updateSlide(0) and startAutoAdvance(), then test everything"
      ].join("\n")
    }
  },
